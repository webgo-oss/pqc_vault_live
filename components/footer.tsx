  ...
  return (
    <div className="logo-wrap" aria-label="PQC Vault logo">
      <svg viewBox="0 0 1254 1254" role="img" aria-labelledby="title desc">
        ...
        <desc id="desc">
          A blue to purple geometric monogram with a central keyhole on a dark
          background.
        </desc>
        <defs>
    ...
    <footer className="footer">
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <p className="footer-brand-desc">
            Post-quantum security for modern systems. Built to protect
            sensitive data now and stay resilient against future quantum
            threats — without compromising performance or compatibility.
          </p>
        </div>

        <div className="footer-col">
          <div className="footer-col-head">Informations</div>
        ...
        <div className="footer-col">
          ...
          <div className="footer-contact-item">
            ...
            <div className="footer-contact-text">
              <strong><a href="https://www.linkedin.com/in/hamza-shaikh-0414193ab/">linkedin</a></strong>
            </div>
          </div>
          ...
          <div className="footer-contact-item">
            ...
            <div className="footer-contact-text">
              <strong><a href="https://github.com/webgo-oss">GitHub</a></strong>
            </div>
          </div>
          ...
          <div className="footer-contact-item">
            ...
            <div className="footer-contact-text">
              <strong>hamzashaikh1654w@gmail.com</strong>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-left">
          <span className="footer-copy">© 2025 PQC Vault. All rights reserved.</span>
          <div className="footer-legal-links">
            <a href="#fec">features</a>
            <a href="#algo">algorithms</a>
          </div>
        </div>

        <div className="footer-bottom-right">
          <span className="footer-nist-badge">NIST FIPS 203/204/205</span>
          <span className="footer-nist-badge">Post-Quantum Ready</span>
        </div>
      </div>
    </footer>
  );
